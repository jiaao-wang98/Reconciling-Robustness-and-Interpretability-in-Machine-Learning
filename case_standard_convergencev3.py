...
def analyse_journal(journal):
    ...
    # plot posterior
    journal.plot_posterior_distr(path_to_save="standard_posterior3_n=10000.png")

    # save and load journal
    journal.save("standard_experiments3_n=10000.jnl")

    from abcpy.output import Journal
    new_journal = Journal.fromFile('standard_experiments3_n=10000.jnl')
