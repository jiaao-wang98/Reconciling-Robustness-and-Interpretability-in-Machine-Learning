...
def analyse_journal(journal):
    ...
    # plot posterior
    journal.plot_posterior_distr(path_to_save="standard_posterior.png")

    # save and load journal
    journal.save("standard_experiments.jnl")

    from abcpy.output import Journal
    new_journal = Journal.fromFile('standard_experiments.jnl')
